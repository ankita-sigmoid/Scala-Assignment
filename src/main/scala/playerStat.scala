...
object playerStat {
  ...
  def push_into(year: Int, playerName: String, country: String, matches: Int, runs: Int, wickets: Int): playerStat = {
    var playerStat = new playerStat(year, playerName, country, matches, runs, wickets);
    return playerStat;
  }

  def main(args: Array[String]): Unit = {
    val bufferedSource = scala.io.Source.fromFile("/Users/ankitapriya/Downloads/player.csv")
